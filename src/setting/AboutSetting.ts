...
//个人信息部分配置
const AVATAR_FILENAME = "my_avatar.jpg"; //头像配置，头像需要放进public文件夹内，这里只写文件名和后缀
//处理头像路径的函数(无需修改)
...
//关于我页面一二三段
export const aboutMeP1 = "天津理工大学大数据专业就读，2027年毕业 ";
export const aboutMeP2 = "热爱技术，热爱生活，希望自己能创造更多价值，成就更好的自己 ";
...
export const mail = "mailto:l18840756059@163.com"; //邮箱配置
export const github = "https://github.com/kids1934"; //github网站配置
